...
assert(appJs.includes("drawHudPanel(cw - pad - 170, pad, 170, 'LIVES', Math.max(0, playerLives), '#ff5050', 'right');"), 'app.js must render LIVES panel');
assert(appJs.includes("drawHudPanel(cw/2 - 140, ch - pad - frameH, 280, 'THREATS', threatsValue, threatsColor, 'center');"), 'app.js must render THREATS panel');
